...
struct theXDataTransferEventListenerType : public rtl::StaticWithInit< ::css::uno::Type *, theXDataTransferEventListenerType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.io.XDataTransferEventListener" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.io.XDataTransferEventListener::finished" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.io.XDataTransferEventListener::cancelled" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::io::XDataTransferEventListener const *) {
    const ::css::uno::Type &rRet = *detail::theXDataTransferEventListenerType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamType0( "com.sun.star.io.DataTransferEvent" );
