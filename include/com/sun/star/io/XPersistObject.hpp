...
struct theXPersistObjectType : public rtl::StaticWithInit< ::css::uno::Type *, theXPersistObjectType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.io.XPersistObject" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.io.XPersistObject::getServiceName" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.io.XPersistObject::write" );
        typelib_typedescriptionreference_new( &pMembers[1],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName1.pData );
        ::rtl::OUString sMethodName2( "com.sun.star.io.XPersistObject::read" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::io::XPersistObject const *) {
    const ::css::uno::Type &rRet = *detail::theXPersistObjectType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            }
            {
                ...
                ::rtl::OUString sParamName0( "OutStream" );
                ::rtl::OUString sParamType0( "com.sun.star.io.XObjectOutputStream" );
            ...
            {
                typelib_Parameter_Init aParameters[1];
                ::rtl::OUString sParamName0( "InStream" );
                ::rtl::OUString sParamType0( "com.sun.star.io.XObjectInputStream" );
                aParameters[0].pParamName = sParamName0.pData;
                aParameters[0].eTypeClass = (typelib_TypeClass)::css::uno::TypeClass_INTERFACE;
                aParameters[0].pTypeName = sParamType0.pData;
                aParameters[0].bIn = sal_True;
...
template<> struct IsUnoInterfaceType<::css::io::XPersistObject>: ::std::true_type {};
}
#endif
