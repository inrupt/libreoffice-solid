...
struct theXDataImporterType : public rtl::StaticWithInit< ::css::uno::Type *, theXDataImporterType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.io.XDataImporter" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.io.XDataImporter::importData" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.io.XDataImporter::cancel" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::io::XDataImporter const *) {
    const ::css::uno::Type &rRet = *detail::theXDataImporterType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamName0( "aActiveSource" );
                ::rtl::OUString sParamType0( "com.sun.star.io.XActiveDataSource" );
