...
struct theXDataExporterType : public rtl::StaticWithInit< ::css::uno::Type *, theXDataExporterType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.io.XDataExporter" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.io.XDataExporter::exportData" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.io.XDataExporter::cancel" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::io::XDataExporter const *) {
    const ::css::uno::Type &rRet = *detail::theXDataExporterType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamName0( "aOutputStream" );
                ::rtl::OUString sParamType0( "com.sun.star.io.XOutputStream" );
                aParameters[0].pParamName = sParamName0.pData;
                aParameters[0].eTypeClass = (typelib_TypeClass)::css::uno::TypeClass_INTERFACE;
                aParameters[0].pTypeName = sParamType0.pData;
                aParameters[0].bIn = sal_True;
                aParameters[0].bOut = sal_False;
                ::rtl::OUString sParamName1( "Component" );
                ::rtl::OUString sParamType1( "com.sun.star.lang.XComponent" );
                ...
                ::rtl::OUString sParamName2( "aListener" );
                ::rtl::OUString sParamType2( "com.sun.star.io.XDataTransferEventListener" );
...
template<> struct IsUnoInterfaceType<::css::io::XDataExporter>: ::std::true_type {};
}
#endif
