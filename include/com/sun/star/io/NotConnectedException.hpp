...
struct theNotConnectedExceptionType : public rtl::StaticWithInit< ::css::uno::Type *, theNotConnectedExceptionType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.io.NotConnectedException" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::io::NotConnectedException const *) {
    return *detail::theNotConnectedExceptionType::get();
}
