...
struct theXSequenceOutputStreamType : public rtl::StaticWithInit< ::css::uno::Type *, theXSequenceOutputStreamType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.io.XSequenceOutputStream" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.io.XSequenceOutputStream::getWrittenBytes" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::io::XSequenceOutputStream const *) {
    const ::css::uno::Type &rRet = *detail::theXSequenceOutputStreamType::get();
