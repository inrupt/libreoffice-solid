...
{
    ::cppu::UnoType< ::css::io::AlreadyConnectedException >::get();
}
...
struct theAlreadyConnectedExceptionType : public rtl::StaticWithInit< ::css::uno::Type *, theAlreadyConnectedExceptionType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.io.AlreadyConnectedException" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::io::AlreadyConnectedException const *) {
    return *detail::theAlreadyConnectedExceptionType::get();
}
