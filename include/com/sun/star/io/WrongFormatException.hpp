...
{
    ::cppu::UnoType< ::css::io::WrongFormatException >::get();
}
...
struct theWrongFormatExceptionType : public rtl::StaticWithInit< ::css::uno::Type *, theWrongFormatExceptionType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.io.WrongFormatException" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::io::WrongFormatException const *) {
    return *detail::theWrongFormatExceptionType::get();
}
