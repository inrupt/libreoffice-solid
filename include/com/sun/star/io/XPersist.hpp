...
struct theXPersistType : public rtl::StaticWithInit< ::css::uno::Type *, theXPersistType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.io.XPersist" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.io.XPersist::write" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.io.XPersist::read" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::io::XPersist const *) {
    const ::css::uno::Type &rRet = *detail::theXPersistType::get();
...
template<> struct IsUnoInterfaceType<::css::io::XPersist>: ::std::true_type {};
}
#endif
