...
struct theXObjectInputStreamType : public rtl::StaticWithInit< ::css::uno::Type *, theXObjectInputStreamType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.io.XObjectInputStream" );

        // Start inline typedescription generation
        typelib_InterfaceTypeDescription * pTD = 0;

        typelib_TypeDescriptionReference * aSuperTypes[1];
        aSuperTypes[0] = ::cppu::UnoType< ::css::uno::Reference< ::css::io::XDataInputStream > >::get().getTypeLibType();
        typelib_TypeDescriptionReference * pMembers[1] = { 0 };
        ::rtl::OUString sMethodName0( "com.sun.star.io.XObjectInputStream::readObject" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::io::XObjectInputStream const *) {
    const ::css::uno::Type &rRet = *detail::theXObjectInputStreamType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sReturnType0( "com.sun.star.io.XPersistObject" );
                ::rtl::OUString sMethodName0( "com.sun.star.io.XObjectInputStream::readObject" );
...
template<> struct IsUnoInterfaceType<::css::io::XObjectInputStream>: ::std::true_type {};
}
#endif
