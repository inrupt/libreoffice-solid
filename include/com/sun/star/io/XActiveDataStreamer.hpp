...
struct theXActiveDataStreamerType : public rtl::StaticWithInit< ::css::uno::Type *, theXActiveDataStreamerType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.io.XActiveDataStreamer" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.io.XActiveDataStreamer::setStream" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.io.XActiveDataStreamer::getStream" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::io::XActiveDataStreamer const *) {
    const ::css::uno::Type &rRet = *detail::theXActiveDataStreamerType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamType0( "com.sun.star.io.XStream" );
            ...
            }
            {
                ::rtl::OUString the_ExceptionName0( "com.sun.star.uno.RuntimeException" );
                rtl_uString * the_Exceptions[] = { the_ExceptionName0.pData };
                ::rtl::OUString sReturnType1( "com.sun.star.io.XStream" );
                ::rtl::OUString sMethodName1( "com.sun.star.io.XActiveDataStreamer::getStream" );
                typelib_typedescription_newInterfaceMethod( &pMethod,
                    4, sal_False,
                    sMethodName1.pData,
