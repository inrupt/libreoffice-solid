...
struct theXObjectOutputStreamType : public rtl::StaticWithInit< ::css::uno::Type *, theXObjectOutputStreamType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.io.XObjectOutputStream" );

        // Start inline typedescription generation
        typelib_InterfaceTypeDescription * pTD = 0;

        typelib_TypeDescriptionReference * aSuperTypes[1];
        aSuperTypes[0] = ::cppu::UnoType< ::css::uno::Reference< ::css::io::XDataOutputStream > >::get().getTypeLibType();
        typelib_TypeDescriptionReference * pMembers[1] = { 0 };
        ::rtl::OUString sMethodName0( "com.sun.star.io.XObjectOutputStream::writeObject" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::io::XObjectOutputStream const *) {
    const ::css::uno::Type &rRet = *detail::theXObjectOutputStreamType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamName0( "Object" );
                ::rtl::OUString sParamType0( "com.sun.star.io.XPersistObject" );
...
template<> struct IsUnoInterfaceType<::css::io::XObjectOutputStream>: ::std::true_type {};
}
#endif
