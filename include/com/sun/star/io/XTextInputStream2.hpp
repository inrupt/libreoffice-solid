...
struct theXTextInputStream2Type : public rtl::StaticWithInit< ::css::uno::Type *, theXTextInputStream2Type >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.io.XTextInputStream2" );

        // Start inline typedescription generation
        typelib_InterfaceTypeDescription * pTD = 0;

        typelib_TypeDescriptionReference * aSuperTypes[2];
        aSuperTypes[0] = ::cppu::UnoType< ::css::uno::Reference< ::css::io::XTextInputStream > >::get().getTypeLibType();
        aSuperTypes[1] = ::cppu::UnoType< ::css::uno::Reference< ::css::io::XActiveDataSink > >::get().getTypeLibType();
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::io::XTextInputStream2 const *) {
    const ::css::uno::Type &rRet = *detail::theXTextInputStream2Type::get();
