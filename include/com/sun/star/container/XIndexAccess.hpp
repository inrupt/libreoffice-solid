...
struct theXIndexAccessType : public rtl::StaticWithInit< ::css::uno::Type *, theXIndexAccessType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.container.XIndexAccess" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.container.XIndexAccess::getCount" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.container.XIndexAccess::getByIndex" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::container::XIndexAccess const *) {
    const ::css::uno::Type &rRet = *detail::theXIndexAccessType::get();
