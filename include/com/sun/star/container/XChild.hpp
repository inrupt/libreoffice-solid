...
struct theXChildType : public rtl::StaticWithInit< ::css::uno::Type *, theXChildType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.container.XChild" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.container.XChild::getParent" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.container.XChild::setParent" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::container::XChild const *) {
    const ::css::uno::Type &rRet = *detail::theXChildType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            }
            {
                ...
                ::rtl::OUString sParamName0( "Parent" );
