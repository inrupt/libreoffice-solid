...
struct theXImplicitIDReplaceType : public rtl::StaticWithInit< ::css::uno::Type *, theXImplicitIDReplaceType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.container.XImplicitIDReplace" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.container.XImplicitIDReplace::replaceByUniqueID" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::container::XImplicitIDReplace const *) {
    const ::css::uno::Type &rRet = *detail::theXImplicitIDReplaceType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamName1( "aNewElement" );
