...
struct theNoSuchElementExceptionType : public rtl::StaticWithInit< ::css::uno::Type *, theNoSuchElementExceptionType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.container.NoSuchElementException" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::container::NoSuchElementException const *) {
    return *detail::theNoSuchElementExceptionType::get();
}
