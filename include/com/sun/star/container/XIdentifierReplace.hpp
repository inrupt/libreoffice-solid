...
struct theXIdentifierReplaceType : public rtl::StaticWithInit< ::css::uno::Type *, theXIdentifierReplaceType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.container.XIdentifierReplace" );

        // Start inline typedescription generation
        typelib_InterfaceTypeDescription * pTD = 0;

        typelib_TypeDescriptionReference * aSuperTypes[1];
        aSuperTypes[0] = ::cppu::UnoType< ::css::uno::Reference< ::css::container::XIdentifierAccess > >::get().getTypeLibType();
        typelib_TypeDescriptionReference * pMembers[1] = { 0 };
        ::rtl::OUString sMethodName0( "com.sun.star.container.XIdentifierReplace::replaceByIdentifer" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::container::XIdentifierReplace const *) {
    const ::css::uno::Type &rRet = *detail::theXIdentifierReplaceType::get();
