...
struct theXHierarchicalNameReplaceType : public rtl::StaticWithInit< ::css::uno::Type *, theXHierarchicalNameReplaceType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.container.XHierarchicalNameReplace" );

        // Start inline typedescription generation
        typelib_InterfaceTypeDescription * pTD = 0;

        typelib_TypeDescriptionReference * aSuperTypes[1];
        aSuperTypes[0] = ::cppu::UnoType< ::css::uno::Reference< ::css::container::XHierarchicalNameAccess > >::get().getTypeLibType();
        typelib_TypeDescriptionReference * pMembers[1] = { 0 };
        ::rtl::OUString sMethodName0( "com.sun.star.container.XHierarchicalNameReplace::replaceByHierarchicalName" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::container::XHierarchicalNameReplace const *) {
    const ::css::uno::Type &rRet = *detail::theXHierarchicalNameReplaceType::get();
...
template<> struct IsUnoInterfaceType<::css::container::XHierarchicalNameReplace>: ::std::true_type {};
}
#endif
