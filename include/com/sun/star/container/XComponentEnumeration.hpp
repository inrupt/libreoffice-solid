...
struct theXComponentEnumerationType : public rtl::StaticWithInit< ::css::uno::Type *, theXComponentEnumerationType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.container.XComponentEnumeration" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.container.XComponentEnumeration::nextComponent" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::container::XComponentEnumeration const *) {
    const ::css::uno::Type &rRet = *detail::theXComponentEnumerationType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sReturnType0( "com.sun.star.lang.XComponent" );
                ::rtl::OUString sMethodName0( "com.sun.star.container.XComponentEnumeration::nextComponent" );
...
template<> struct IsUnoInterfaceType<::css::container::XComponentEnumeration>: ::std::true_type {};
}
#endif
