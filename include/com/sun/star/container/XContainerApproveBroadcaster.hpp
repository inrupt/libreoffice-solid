...
struct theXContainerApproveBroadcasterType : public rtl::StaticWithInit< ::css::uno::Type *, theXContainerApproveBroadcasterType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.container.XContainerApproveBroadcaster" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.container.XContainerApproveBroadcaster::addContainerApproveListener" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.container.XContainerApproveBroadcaster::removeContainerApproveListener" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::container::XContainerApproveBroadcaster const *) {
    const ::css::uno::Type &rRet = *detail::theXContainerApproveBroadcasterType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamType0( "com.sun.star.container.XContainerApproveListener" );
