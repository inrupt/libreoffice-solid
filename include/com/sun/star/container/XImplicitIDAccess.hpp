...
struct theXImplicitIDAccessType : public rtl::StaticWithInit< ::css::uno::Type *, theXImplicitIDAccessType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.container.XImplicitIDAccess" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.container.XImplicitIDAccess::getByImplicitID" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.container.XImplicitIDAccess::getImplicitIDs" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::container::XImplicitIDAccess const *) {
    const ::css::uno::Type &rRet = *detail::theXImplicitIDAccessType::get();
