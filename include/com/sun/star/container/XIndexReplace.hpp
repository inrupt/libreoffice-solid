...
struct theXIndexReplaceType : public rtl::StaticWithInit< ::css::uno::Type *, theXIndexReplaceType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.container.XIndexReplace" );

        // Start inline typedescription generation
        typelib_InterfaceTypeDescription * pTD = 0;

        typelib_TypeDescriptionReference * aSuperTypes[1];
        aSuperTypes[0] = ::cppu::UnoType< ::css::uno::Reference< ::css::container::XIndexAccess > >::get().getTypeLibType();
        typelib_TypeDescriptionReference * pMembers[1] = { 0 };
        ::rtl::OUString sMethodName0( "com.sun.star.container.XIndexReplace::replaceByIndex" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::container::XIndexReplace const *) {
    const ::css::uno::Type &rRet = *detail::theXIndexReplaceType::get();
...
template<> struct IsUnoInterfaceType<::css::container::XIndexReplace>: ::std::true_type {};
}
#endif
