...
struct theXHierarchicalNameContainerType : public rtl::StaticWithInit< ::css::uno::Type *, theXHierarchicalNameContainerType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.container.XHierarchicalNameContainer" );

        // Start inline typedescription generation
        typelib_InterfaceTypeDescription * pTD = 0;

        typelib_TypeDescriptionReference * aSuperTypes[1];
        aSuperTypes[0] = ::cppu::UnoType< ::css::uno::Reference< ::css::container::XHierarchicalNameReplace > >::get().getTypeLibType();
        typelib_TypeDescriptionReference * pMembers[2] = { 0,0 };
        ::rtl::OUString sMethodName0( "com.sun.star.container.XHierarchicalNameContainer::insertByHierarchicalName" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.container.XHierarchicalNameContainer::removeByHierarchicalName" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::container::XHierarchicalNameContainer const *) {
    const ::css::uno::Type &rRet = *detail::theXHierarchicalNameContainerType::get();
...
template<> struct IsUnoInterfaceType<::css::container::XHierarchicalNameContainer>: ::std::true_type {};
}
#endif
