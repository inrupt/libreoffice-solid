...
struct theXWarningsSupplierType : public rtl::StaticWithInit< ::css::uno::Type *, theXWarningsSupplierType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.sdbc.XWarningsSupplier" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.sdbc.XWarningsSupplier::getWarnings" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.sdbc.XWarningsSupplier::clearWarnings" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::sdbc::XWarningsSupplier const *) {
    const ::css::uno::Type &rRet = *detail::theXWarningsSupplierType::get();
