...
struct theXColumnLocateType : public rtl::StaticWithInit< ::css::uno::Type *, theXColumnLocateType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.sdbc.XColumnLocate" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.sdbc.XColumnLocate::findColumn" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::sdbc::XColumnLocate const *) {
    const ::css::uno::Type &rRet = *detail::theXColumnLocateType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamName0( "columnName" );
...
template<> struct IsUnoInterfaceType<::css::sdbc::XColumnLocate>: ::std::true_type {};
}
#endif
