...
struct theXPooledConnectionType : public rtl::StaticWithInit< ::css::uno::Type *, theXPooledConnectionType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.sdbc.XPooledConnection" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.sdbc.XPooledConnection::getConnection" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::sdbc::XPooledConnection const *) {
    const ::css::uno::Type &rRet = *detail::theXPooledConnectionType::get();
