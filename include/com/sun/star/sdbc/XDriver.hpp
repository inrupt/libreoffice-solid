...
struct theXDriverType : public rtl::StaticWithInit< ::css::uno::Type *, theXDriverType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.sdbc.XDriver" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.sdbc.XDriver::connect" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.sdbc.XDriver::acceptsURL" );
        typelib_typedescriptionreference_new( &pMembers[1],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName1.pData );
        ::rtl::OUString sMethodName2( "com.sun.star.sdbc.XDriver::getPropertyInfo" );
        typelib_typedescriptionreference_new( &pMembers[2],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName2.pData );
        ::rtl::OUString sMethodName3( "com.sun.star.sdbc.XDriver::getMajorVersion" );
        typelib_typedescriptionreference_new( &pMembers[3],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName3.pData );
        ::rtl::OUString sMethodName4( "com.sun.star.sdbc.XDriver::getMinorVersion" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::sdbc::XDriver const *) {
    const ::css::uno::Type &rRet = *detail::theXDriverType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamName1( "info" );
                ::rtl::OUString sParamType1( "[]com.sun.star.beans.PropertyValue" );
                ...
                ::rtl::OUString sReturnType0( "com.sun.star.sdbc.XConnection" );
                ::rtl::OUString sMethodName0( "com.sun.star.sdbc.XDriver::connect" );
            ...
            }
            {
                ...
                ::rtl::OUString the_ExceptionName1( "com.sun.star.uno.RuntimeException" );
                rtl_uString * the_Exceptions[] = { the_ExceptionName0.pData, the_ExceptionName1.pData };
                ::rtl::OUString sReturnType2( "[]com.sun.star.sdbc.DriverPropertyInfo" );
                ::rtl::OUString sMethodName2( "com.sun.star.sdbc.XDriver::getPropertyInfo" );
                typelib_typedescription_newInterfaceMethod( &pMethod,
                    5, sal_False,
                    sMethodName2.pData,
