...
struct theXDataSourceType : public rtl::StaticWithInit< ::css::uno::Type *, theXDataSourceType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.sdbc.XDataSource" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.sdbc.XDataSource::getConnection" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.sdbc.XDataSource::setLoginTimeout" );
        typelib_typedescriptionreference_new( &pMembers[1],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName1.pData );
        ::rtl::OUString sMethodName2( "com.sun.star.sdbc.XDataSource::getLoginTimeout" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::sdbc::XDataSource const *) {
    const ::css::uno::Type &rRet = *detail::theXDataSourceType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamName1( "password" );
            ...
            }
            {
                ...
                ::rtl::OUString sParamName0( "seconds" );
...
template<> struct IsUnoInterfaceType<::css::sdbc::XDataSource>: ::std::true_type {};
}
#endif
