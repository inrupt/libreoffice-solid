...
struct theXStructType : public rtl::StaticWithInit< ::css::uno::Type *, theXStructType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.sdbc.XStruct" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.sdbc.XStruct::getSQLTypeName" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.sdbc.XStruct::getAttributes" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::sdbc::XStruct const *) {
    const ::css::uno::Type &rRet = *detail::theXStructType::get();
