...
struct theXDatabaseMetaData2Type : public rtl::StaticWithInit< ::css::uno::Type *, theXDatabaseMetaData2Type >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.sdbc.XDatabaseMetaData2" );

        // Start inline typedescription generation
        typelib_InterfaceTypeDescription * pTD = 0;

        typelib_TypeDescriptionReference * aSuperTypes[1];
        aSuperTypes[0] = ::cppu::UnoType< ::css::uno::Reference< ::css::sdbc::XDatabaseMetaData > >::get().getTypeLibType();
        typelib_TypeDescriptionReference * pMembers[1] = { 0 };
        ::rtl::OUString sMethodName0( "com.sun.star.sdbc.XDatabaseMetaData2::getConnectionInfo" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::sdbc::XDatabaseMetaData2 const *) {
    const ::css::uno::Type &rRet = *detail::theXDatabaseMetaData2Type::get();
