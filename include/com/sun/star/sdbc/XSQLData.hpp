...
struct theXSQLDataType : public rtl::StaticWithInit< ::css::uno::Type *, theXSQLDataType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.sdbc.XSQLData" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.sdbc.XSQLData::getSQLTypeName" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.sdbc.XSQLData::readSQL" );
        typelib_typedescriptionreference_new( &pMembers[1],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName1.pData );
        ::rtl::OUString sMethodName2( "com.sun.star.sdbc.XSQLData::writeSQL" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::sdbc::XSQLData const *) {
    const ::css::uno::Type &rRet = *detail::theXSQLDataType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            }
            {
                ...
                ::rtl::OUString sParamName0( "stream" );
                ::rtl::OUString sParamType0( "com.sun.star.sdbc.XSQLInput" );
                aParameters[0].pParamName = sParamName0.pData;
                aParameters[0].eTypeClass = (typelib_TypeClass)::css::uno::TypeClass_INTERFACE;
                aParameters[0].pTypeName = sParamType0.pData;
                aParameters[0].bIn = sal_True;
                aParameters[0].bOut = sal_False;
                ::rtl::OUString sParamName1( "typeName" );
            ...
            }
            {
                ...
                ::rtl::OUString sParamName0( "stream" );
                ::rtl::OUString sParamType0( "com.sun.star.sdbc.XSQLOutput" );
                aParameters[0].pParamName = sParamName0.pData;
                aParameters[0].eTypeClass = (typelib_TypeClass)::css::uno::TypeClass_INTERFACE;
                aParameters[0].pTypeName = sParamType0.pData;
                aParameters[0].bIn = sal_True;
...
template<> struct IsUnoInterfaceType<::css::sdbc::XSQLData>: ::std::true_type {};
}
#endif
