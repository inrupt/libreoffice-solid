...
struct theXCloseableType : public rtl::StaticWithInit< ::css::uno::Type *, theXCloseableType >
{
    ...
    {
        ::rtl::OUString sTypeName( "com.sun.star.sdbc.XCloseable" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.sdbc.XCloseable::close" );
...
template<> struct IsUnoInterfaceType<::css::sdbc::XCloseable>: ::std::true_type {};
}
#endif
