...
struct theXOutParametersType : public rtl::StaticWithInit< ::css::uno::Type *, theXOutParametersType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.sdbc.XOutParameters" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.sdbc.XOutParameters::registerOutParameter" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.sdbc.XOutParameters::registerNumericOutParameter" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::sdbc::XOutParameters const *) {
    const ::css::uno::Type &rRet = *detail::theXOutParametersType::get();
...
template<> struct IsUnoInterfaceType<::css::sdbc::XOutParameters>: ::std::true_type {};
}
#endif
