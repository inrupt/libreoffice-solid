...
struct theXRefType : public rtl::StaticWithInit< ::css::uno::Type *, theXRefType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.sdbc.XRef" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.sdbc.XRef::getBaseTypeName" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::sdbc::XRef const *) {
    const ::css::uno::Type &rRet = *detail::theXRefType::get();
