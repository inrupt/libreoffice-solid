...
struct theXPublishedType : public rtl::StaticWithInit< ::css::uno::Type *, theXPublishedType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.reflection.XPublished" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.reflection.XPublished::isPublished" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::reflection::XPublished const *) {
    const ::css::uno::Type &rRet = *detail::theXPublishedType::get();
