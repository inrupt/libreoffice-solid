...
struct theXProxyFactoryType : public rtl::StaticWithInit< ::css::uno::Type *, theXProxyFactoryType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.reflection.XProxyFactory" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.reflection.XProxyFactory::createProxy" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::reflection::XProxyFactory const *) {
    const ::css::uno::Type &rRet = *detail::theXProxyFactoryType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamName0( "xTarget" );
                ...
                ::rtl::OUString sReturnType0( "com.sun.star.uno.XAggregation" );
                ::rtl::OUString sMethodName0( "com.sun.star.reflection.XProxyFactory::createProxy" );
...
template<> struct IsUnoInterfaceType<::css::reflection::XProxyFactory>: ::std::true_type {};
}
#endif
