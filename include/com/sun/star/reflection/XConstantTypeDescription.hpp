...
struct theXConstantTypeDescriptionType : public rtl::StaticWithInit< ::css::uno::Type *, theXConstantTypeDescriptionType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.reflection.XConstantTypeDescription" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.reflection.XConstantTypeDescription::getConstantValue" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::reflection::XConstantTypeDescription const *) {
    const ::css::uno::Type &rRet = *detail::theXConstantTypeDescriptionType::get();
