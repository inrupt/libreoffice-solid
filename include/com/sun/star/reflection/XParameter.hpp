...
struct theXParameterType : public rtl::StaticWithInit< ::css::uno::Type *, theXParameterType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.reflection.XParameter" );

        // Start inline typedescription generation
        typelib_InterfaceTypeDescription * pTD = 0;

        typelib_TypeDescriptionReference * aSuperTypes[1];
        aSuperTypes[0] = ::cppu::UnoType< ::css::uno::Reference< ::css::reflection::XMethodParameter > >::get().getTypeLibType();
        typelib_TypeDescriptionReference * pMembers[1] = { 0 };
        ::rtl::OUString sMethodName0( "com.sun.star.reflection.XParameter::isRestParameter" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::reflection::XParameter const *) {
    const ::css::uno::Type &rRet = *detail::theXParameterType::get();
...
template<> struct IsUnoInterfaceType<::css::reflection::XParameter>: ::std::true_type {};
}
#endif
