...
struct theXSingletonTypeDescriptionType : public rtl::StaticWithInit< ::css::uno::Type *, theXSingletonTypeDescriptionType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.reflection.XSingletonTypeDescription" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.reflection.XSingletonTypeDescription::getService" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::reflection::XSingletonTypeDescription const *) {
    const ::css::uno::Type &rRet = *detail::theXSingletonTypeDescriptionType::get();
...
template<> struct IsUnoInterfaceType<::css::reflection::XSingletonTypeDescription>: ::std::true_type {};
}
#endif
