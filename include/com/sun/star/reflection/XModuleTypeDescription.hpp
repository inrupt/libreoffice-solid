...
struct theXModuleTypeDescriptionType : public rtl::StaticWithInit< ::css::uno::Type *, theXModuleTypeDescriptionType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.reflection.XModuleTypeDescription" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.reflection.XModuleTypeDescription::getMembers" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::reflection::XModuleTypeDescription const *) {
    const ::css::uno::Type &rRet = *detail::theXModuleTypeDescriptionType::get();
