...
struct theXArrayTypeDescriptionType : public rtl::StaticWithInit< ::css::uno::Type *, theXArrayTypeDescriptionType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.reflection.XArrayTypeDescription" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.reflection.XArrayTypeDescription::getType" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.reflection.XArrayTypeDescription::getNumberOfDimensions" );
        typelib_typedescriptionreference_new( &pMembers[1],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName1.pData );
        ::rtl::OUString sMethodName2( "com.sun.star.reflection.XArrayTypeDescription::getDimensions" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::reflection::XArrayTypeDescription const *) {
    const ::css::uno::Type &rRet = *detail::theXArrayTypeDescriptionType::get();
