...
struct theXPropertyTypeDescriptionType : public rtl::StaticWithInit< ::css::uno::Type *, theXPropertyTypeDescriptionType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.reflection.XPropertyTypeDescription" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.reflection.XPropertyTypeDescription::getPropertyFlags" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.reflection.XPropertyTypeDescription::getPropertyTypeDescription" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::reflection::XPropertyTypeDescription const *) {
    const ::css::uno::Type &rRet = *detail::theXPropertyTypeDescriptionType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sReturnType0( "short" );
                ::rtl::OUString sMethodName0( "com.sun.star.reflection.XPropertyTypeDescription::getPropertyFlags" );
                typelib_typedescription_newInterfaceMethod( &pMethod,
                    5, sal_False,
                    sMethodName0.pData,
                    (typelib_TypeClass)::css::uno::TypeClass_SHORT, sReturnType0.pData,
                    0, 0,
                    1, the_Exceptions );
...
template<> struct IsUnoInterfaceType<::css::reflection::XPropertyTypeDescription>: ::std::true_type {};
}
#endif
