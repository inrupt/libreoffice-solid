...
struct theCommandAbortedExceptionType : public rtl::StaticWithInit< ::css::uno::Type *, theCommandAbortedExceptionType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.ucb.CommandAbortedException" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::ucb::CommandAbortedException const *) {
    return *detail::theCommandAbortedExceptionType::get();
}
