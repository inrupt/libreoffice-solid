...
struct theXRemoteContentProviderSupplierType : public rtl::StaticWithInit< ::css::uno::Type *, theXRemoteContentProviderSupplierType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.ucb.XRemoteContentProviderSupplier" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.ucb.XRemoteContentProviderSupplier::queryRemoteContentProvider" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::ucb::XRemoteContentProviderSupplier const *) {
    const ::css::uno::Type &rRet = *detail::theXRemoteContentProviderSupplierType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sReturnType0( "com.sun.star.lang.XMultiServiceFactory" );
                ::rtl::OUString sMethodName0( "com.sun.star.ucb.XRemoteContentProviderSupplier::queryRemoteContentProvider" );
