...
struct theXContentType : public rtl::StaticWithInit< ::css::uno::Type *, theXContentType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.ucb.XContent" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.ucb.XContent::getIdentifier" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.ucb.XContent::getContentType" );
        typelib_typedescriptionreference_new( &pMembers[1],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName1.pData );
        ::rtl::OUString sMethodName2( "com.sun.star.ucb.XContent::addContentEventListener" );
        typelib_typedescriptionreference_new( &pMembers[2],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName2.pData );
        ::rtl::OUString sMethodName3( "com.sun.star.ucb.XContent::removeContentEventListener" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::ucb::XContent const *) {
    const ::css::uno::Type &rRet = *detail::theXContentType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sReturnType0( "com.sun.star.ucb.XContentIdentifier" );
                ::rtl::OUString sMethodName0( "com.sun.star.ucb.XContent::getIdentifier" );
            ...
            }
            {
                ...
                ::rtl::OUString sParamType0( "com.sun.star.ucb.XContentEventListener" );
