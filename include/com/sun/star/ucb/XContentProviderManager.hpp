...
struct theXContentProviderManagerType : public rtl::StaticWithInit< ::css::uno::Type *, theXContentProviderManagerType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.ucb.XContentProviderManager" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.ucb.XContentProviderManager::registerContentProvider" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.ucb.XContentProviderManager::deregisterContentProvider" );
        typelib_typedescriptionreference_new( &pMembers[1],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName1.pData );
        ::rtl::OUString sMethodName2( "com.sun.star.ucb.XContentProviderManager::queryContentProviders" );
        typelib_typedescriptionreference_new( &pMembers[2],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName2.pData );
        ::rtl::OUString sMethodName3( "com.sun.star.ucb.XContentProviderManager::queryContentProvider" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::ucb::XContentProviderManager const *) {
    const ::css::uno::Type &rRet = *detail::theXContentProviderManagerType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            ::cppu::UnoType< ::css::ucb::DuplicateProviderException >::get();

            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                typelib_Parameter_Init aParameters[3];
                ::rtl::OUString sParamName0( "Provider" );
                ::rtl::OUString sParamType0( "com.sun.star.ucb.XContentProvider" );
                aParameters[0].pParamName = sParamName0.pData;
                aParameters[0].eTypeClass = (typelib_TypeClass)::css::uno::TypeClass_INTERFACE;
                aParameters[0].pTypeName = sParamType0.pData;
                aParameters[0].bIn = sal_True;
                aParameters[0].bOut = sal_False;
                ::rtl::OUString sParamName1( "Scheme" );
                ...
                ::rtl::OUString sParamName2( "ReplaceExisting" );
                ...
                ::rtl::OUString the_ExceptionName0( "com.sun.star.ucb.DuplicateProviderException" );
                ...
                ::rtl::OUString sReturnType0( "com.sun.star.ucb.XContentProvider" );
                ::rtl::OUString sMethodName0( "com.sun.star.ucb.XContentProviderManager::registerContentProvider" );
            ...
            }
            {
                ::rtl::OUString the_ExceptionName0( "com.sun.star.uno.RuntimeException" );
                rtl_uString * the_Exceptions[] = { the_ExceptionName0.pData };
                ::rtl::OUString sReturnType2( "[]com.sun.star.ucb.ContentProviderInfo" );
                ::rtl::OUString sMethodName2( "com.sun.star.ucb.XContentProviderManager::queryContentProviders" );
                typelib_typedescription_newInterfaceMethod( &pMethod,
                    5, sal_False,
                    sMethodName2.pData,
            ...
            }
            {
                ...
                ::rtl::OUString the_ExceptionName0( "com.sun.star.uno.RuntimeException" );
                rtl_uString * the_Exceptions[] = { the_ExceptionName0.pData };
                ::rtl::OUString sReturnType3( "com.sun.star.ucb.XContentProvider" );
                ::rtl::OUString sMethodName3( "com.sun.star.ucb.XContentProviderManager::queryContentProvider" );
                typelib_typedescription_newInterfaceMethod( &pMethod,
                    6, sal_False,
                    sMethodName3.pData,
...
template<> struct IsUnoInterfaceType<::css::ucb::XContentProviderManager>: ::std::true_type {};
}
#endif
