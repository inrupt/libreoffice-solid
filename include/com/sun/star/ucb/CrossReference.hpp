...
struct theCrossReferenceType : public rtl::StaticWithInit< ::css::uno::Type *, theCrossReferenceType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString the_name( "com.sun.star.ucb.CrossReference" );
        ::rtl::OUString the_tname0( "string" );
        ::rtl::OUString the_name0( "Group" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::ucb::CrossReference const *) {
    return *detail::theCrossReferenceType::get();
}
