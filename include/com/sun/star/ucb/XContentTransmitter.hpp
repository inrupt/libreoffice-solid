...
struct theXContentTransmitterType : public rtl::StaticWithInit< ::css::uno::Type *, theXContentTransmitterType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.ucb.XContentTransmitter" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.ucb.XContentTransmitter::transmit" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::ucb::XContentTransmitter const *) {
    const ::css::uno::Type &rRet = *detail::theXContentTransmitterType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamName1( "Destination" );
                ...
                ::rtl::OUString sParamName2( "Flags" );
...
template<> struct IsUnoInterfaceType<::css::ucb::XContentTransmitter>: ::std::true_type {};
}
#endif
