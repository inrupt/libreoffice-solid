...
struct theXCommandProcessorType : public rtl::StaticWithInit< ::css::uno::Type *, theXCommandProcessorType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.ucb.XCommandProcessor" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.ucb.XCommandProcessor::createCommandIdentifier" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.ucb.XCommandProcessor::execute" );
        typelib_typedescriptionreference_new( &pMembers[1],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName1.pData );
        ::rtl::OUString sMethodName2( "com.sun.star.ucb.XCommandProcessor::abort" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::ucb::XCommandProcessor const *) {
    const ::css::uno::Type &rRet = *detail::theXCommandProcessorType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            }
            {
                ...
                ::rtl::OUString sParamName0( "aCommand" );
                ::rtl::OUString sParamType0( "com.sun.star.ucb.Command" );
                aParameters[0].pParamName = sParamName0.pData;
                aParameters[0].eTypeClass = (typelib_TypeClass)::css::uno::TypeClass_STRUCT;
                aParameters[0].pTypeName = sParamType0.pData;
                aParameters[0].bIn = sal_True;
                aParameters[0].bOut = sal_False;
                ::rtl::OUString sParamName1( "CommandId" );
                ...
                ::rtl::OUString sParamName2( "Environment" );
                ::rtl::OUString sParamType2( "com.sun.star.ucb.XCommandEnvironment" );
                ...
                ::rtl::OUString the_ExceptionName1( "com.sun.star.ucb.CommandAbortedException" );
            ...
            }
            {
                ...
                ::rtl::OUString sParamName0( "CommandId" );
...
template<> struct IsUnoInterfaceType<::css::ucb::XCommandProcessor>: ::std::true_type {};
}
#endif
