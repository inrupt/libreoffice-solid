...
struct theXParameterizedContentProviderType : public rtl::StaticWithInit< ::css::uno::Type *, theXParameterizedContentProviderType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.ucb.XParameterizedContentProvider" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.ucb.XParameterizedContentProvider::registerInstance" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.ucb.XParameterizedContentProvider::deregisterInstance" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::ucb::XParameterizedContentProvider const *) {
    const ::css::uno::Type &rRet = *detail::theXParameterizedContentProviderType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamName0( "Template" );
            ...
            }
            {
                ...
                ::rtl::OUString the_ExceptionName1( "com.sun.star.uno.RuntimeException" );
                rtl_uString * the_Exceptions[] = { the_ExceptionName0.pData, the_ExceptionName1.pData };
                ::rtl::OUString sReturnType1( "com.sun.star.ucb.XContentProvider" );
                ::rtl::OUString sMethodName1( "com.sun.star.ucb.XParameterizedContentProvider::deregisterInstance" );
                typelib_typedescription_newInterfaceMethod( &pMethod,
                    4, sal_False,
                    sMethodName1.pData,
...
template<> struct IsUnoInterfaceType<::css::ucb::XParameterizedContentProvider>: ::std::true_type {};
}
#endif
