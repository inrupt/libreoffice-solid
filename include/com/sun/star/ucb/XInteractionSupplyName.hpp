...
struct theXInteractionSupplyNameType : public rtl::StaticWithInit< ::css::uno::Type *, theXInteractionSupplyNameType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.ucb.XInteractionSupplyName" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.ucb.XInteractionSupplyName::setName" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::ucb::XInteractionSupplyName const *) {
    const ::css::uno::Type &rRet = *detail::theXInteractionSupplyNameType::get();
