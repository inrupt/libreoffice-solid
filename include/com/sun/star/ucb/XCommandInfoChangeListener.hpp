...
struct theXCommandInfoChangeListenerType : public rtl::StaticWithInit< ::css::uno::Type *, theXCommandInfoChangeListenerType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.ucb.XCommandInfoChangeListener" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.ucb.XCommandInfoChangeListener::commandInfoChange" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::ucb::XCommandInfoChangeListener const *) {
    const ::css::uno::Type &rRet = *detail::theXCommandInfoChangeListenerType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamType0( "com.sun.star.ucb.CommandInfoChangeEvent" );
