...
struct theXRemoteContentProviderActivatorType : public rtl::StaticWithInit< ::css::uno::Type *, theXRemoteContentProviderActivatorType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.ucb.XRemoteContentProviderActivator" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.ucb.XRemoteContentProviderActivator::activateRemoteContentProviders" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::ucb::XRemoteContentProviderActivator const *) {
    const ::css::uno::Type &rRet = *detail::theXRemoteContentProviderActivatorType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sReturnType0( "com.sun.star.ucb.XContentProviderManager" );
                ::rtl::OUString sMethodName0( "com.sun.star.ucb.XRemoteContentProviderActivator::activateRemoteContentProviders" );
...
template<> struct IsUnoInterfaceType<::css::ucb::XRemoteContentProviderActivator>: ::std::true_type {};
}
#endif
