...
{
    ::cppu::UnoType< ::css::ucb::DuplicateCommandIdentifierException >::get();
}
...
struct theDuplicateCommandIdentifierExceptionType : public rtl::StaticWithInit< ::css::uno::Type *, theDuplicateCommandIdentifierExceptionType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.ucb.DuplicateCommandIdentifierException" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::ucb::DuplicateCommandIdentifierException const *) {
    return *detail::theDuplicateCommandIdentifierExceptionType::get();
}
