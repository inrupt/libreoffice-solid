...
struct theXCachedContentResultSetFactoryType : public rtl::StaticWithInit< ::css::uno::Type *, theXCachedContentResultSetFactoryType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.ucb.XCachedContentResultSetFactory" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.ucb.XCachedContentResultSetFactory::createCachedContentResultSet" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::ucb::XCachedContentResultSetFactory const *) {
    const ::css::uno::Type &rRet = *detail::theXCachedContentResultSetFactoryType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamName0( "xSource" );
                ::rtl::OUString sParamType0( "com.sun.star.sdbc.XResultSet" );
                aParameters[0].pParamName = sParamName0.pData;
                aParameters[0].eTypeClass = (typelib_TypeClass)::css::uno::TypeClass_INTERFACE;
                aParameters[0].pTypeName = sParamType0.pData;
                aParameters[0].bIn = sal_True;
                aParameters[0].bOut = sal_False;
                ::rtl::OUString sParamName1( "xMapping" );
                ::rtl::OUString sParamType1( "com.sun.star.ucb.XContentIdentifierMapping" );
...
template<> struct IsUnoInterfaceType<::css::ucb::XCachedContentResultSetFactory>: ::std::true_type {};
}
#endif
