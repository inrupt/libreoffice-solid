...
struct theXContentProviderType : public rtl::StaticWithInit< ::css::uno::Type *, theXContentProviderType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.ucb.XContentProvider" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.ucb.XContentProvider::queryContent" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.ucb.XContentProvider::compareContentIds" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::ucb::XContentProvider const *) {
    const ::css::uno::Type &rRet = *detail::theXContentProviderType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            ::cppu::UnoType< ::css::ucb::IllegalIdentifierException >::get();

            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                typelib_Parameter_Init aParameters[1];
                ::rtl::OUString sParamName0( "Identifier" );
                ::rtl::OUString sParamType0( "com.sun.star.ucb.XContentIdentifier" );
                aParameters[0].pParamName = sParamName0.pData;
                aParameters[0].eTypeClass = (typelib_TypeClass)::css::uno::TypeClass_INTERFACE;
                aParameters[0].pTypeName = sParamType0.pData;
                aParameters[0].bIn = sal_True;
                aParameters[0].bOut = sal_False;
                ::rtl::OUString the_ExceptionName0( "com.sun.star.ucb.IllegalIdentifierException" );
                ...
                ::rtl::OUString sReturnType0( "com.sun.star.ucb.XContent" );
                ::rtl::OUString sMethodName0( "com.sun.star.ucb.XContentProvider::queryContent" );
            ...
            }
            {
                ...
                aParameters[0].bIn = sal_True;
                aParameters[0].bOut = sal_False;
                ::rtl::OUString sParamName1( "Id2" );
                ::rtl::OUString sParamType1( "com.sun.star.ucb.XContentIdentifier" );
