...
inline InteractiveNetworkConnectException::InteractiveNetworkConnectException(
    ...
    , Server()
{
    ::cppu::UnoType< ::css::ucb::InteractiveNetworkConnectException >::get();
}
...
struct theInteractiveNetworkConnectExceptionType : public rtl::StaticWithInit< ::css::uno::Type *, theInteractiveNetworkConnectExceptionType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.ucb.InteractiveNetworkConnectException" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::ucb::InteractiveNetworkConnectException const *) {
    return *detail::theInteractiveNetworkConnectExceptionType::get();
}
