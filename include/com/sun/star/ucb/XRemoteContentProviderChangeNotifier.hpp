...
struct theXRemoteContentProviderChangeNotifierType : public rtl::StaticWithInit< ::css::uno::Type *, theXRemoteContentProviderChangeNotifierType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.ucb.XRemoteContentProviderChangeNotifier" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.ucb.XRemoteContentProviderChangeNotifier::addRemoteContentProviderChangeListener" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.ucb.XRemoteContentProviderChangeNotifier::removeRemoteContentProviderChangeListener" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::ucb::XRemoteContentProviderChangeNotifier const *) {
    const ::css::uno::Type &rRet = *detail::theXRemoteContentProviderChangeNotifierType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamType0( "com.sun.star.ucb.XRemoteContentProviderChangeListener" );
