...
struct theXContentProviderFactoryType : public rtl::StaticWithInit< ::css::uno::Type *, theXContentProviderFactoryType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.ucb.XContentProviderFactory" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.ucb.XContentProviderFactory::createContentProvider" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::ucb::XContentProviderFactory const *) {
    const ::css::uno::Type &rRet = *detail::theXContentProviderFactoryType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamName0( "Service" );
