...
struct theListenerAlreadySetExceptionType : public rtl::StaticWithInit< ::css::uno::Type *, theListenerAlreadySetExceptionType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.ucb.ListenerAlreadySetException" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::ucb::ListenerAlreadySetException const *) {
    return *detail::theListenerAlreadySetExceptionType::get();
}
