...
struct theXCommandInfoType : public rtl::StaticWithInit< ::css::uno::Type *, theXCommandInfoType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.ucb.XCommandInfo" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.ucb.XCommandInfo::getCommands" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.ucb.XCommandInfo::getCommandInfoByName" );
        typelib_typedescriptionreference_new( &pMembers[1],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName1.pData );
        ::rtl::OUString sMethodName2( "com.sun.star.ucb.XCommandInfo::getCommandInfoByHandle" );
        typelib_typedescriptionreference_new( &pMembers[2],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName2.pData );
        ::rtl::OUString sMethodName3( "com.sun.star.ucb.XCommandInfo::hasCommandByName" );
        typelib_typedescriptionreference_new( &pMembers[3],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName3.pData );
        ::rtl::OUString sMethodName4( "com.sun.star.ucb.XCommandInfo::hasCommandByHandle" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::ucb::XCommandInfo const *) {
    const ::css::uno::Type &rRet = *detail::theXCommandInfoType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sReturnType0( "[]com.sun.star.ucb.CommandInfo" );
                ::rtl::OUString sMethodName0( "com.sun.star.ucb.XCommandInfo::getCommands" );
            ...
            }
            {
                ...
                ::rtl::OUString the_ExceptionName0( "com.sun.star.ucb.UnsupportedCommandException" );
                ...
                ::rtl::OUString sReturnType1( "com.sun.star.ucb.CommandInfo" );
                ::rtl::OUString sMethodName1( "com.sun.star.ucb.XCommandInfo::getCommandInfoByName" );
                typelib_typedescription_newInterfaceMethod( &pMethod,
                    4, sal_False,
                    sMethodName1.pData,
            ...
            {
                typelib_Parameter_Init aParameters[1];
                ::rtl::OUString sParamName0( "Handle" );
                ...
                ::rtl::OUString the_ExceptionName1( "com.sun.star.uno.RuntimeException" );
                rtl_uString * the_Exceptions[] = { the_ExceptionName0.pData, the_ExceptionName1.pData };
                ::rtl::OUString sReturnType2( "com.sun.star.ucb.CommandInfo" );
                ::rtl::OUString sMethodName2( "com.sun.star.ucb.XCommandInfo::getCommandInfoByHandle" );
                typelib_typedescription_newInterfaceMethod( &pMethod,
                    5, sal_False,
                    sMethodName2.pData,
