...
struct theXInteractionSupplyAuthentication2Type : public rtl::StaticWithInit< ::css::uno::Type *, theXInteractionSupplyAuthentication2Type >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.ucb.XInteractionSupplyAuthentication2" );

        // Start inline typedescription generation
        typelib_InterfaceTypeDescription * pTD = 0;

        typelib_TypeDescriptionReference * aSuperTypes[1];
        aSuperTypes[0] = ::cppu::UnoType< ::css::uno::Reference< ::css::ucb::XInteractionSupplyAuthentication > >::get().getTypeLibType();
        typelib_TypeDescriptionReference * pMembers[2] = { 0,0 };
        ::rtl::OUString sMethodName0( "com.sun.star.ucb.XInteractionSupplyAuthentication2::canUseSystemCredentials" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.ucb.XInteractionSupplyAuthentication2::setUseSystemCredentials" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::ucb::XInteractionSupplyAuthentication2 const *) {
    const ::css::uno::Type &rRet = *detail::theXInteractionSupplyAuthentication2Type::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            {
                typelib_Parameter_Init aParameters[1];
                ::rtl::OUString sParamName0( "UseSystemCredentials" );
                ::rtl::OUString sParamType0( "boolean" );
                aParameters[0].pParamName = sParamName0.pData;
                aParameters[0].eTypeClass = (typelib_TypeClass)::css::uno::TypeClass_BOOLEAN;
                aParameters[0].pTypeName = sParamType0.pData;
...
template<> struct IsUnoInterfaceType<::css::ucb::XInteractionSupplyAuthentication2>: ::std::true_type {};
}
#endif
