...
struct theXAnyCompareFactoryType : public rtl::StaticWithInit< ::css::uno::Type *, theXAnyCompareFactoryType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.ucb.XAnyCompareFactory" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.ucb.XAnyCompareFactory::createAnyCompareByName" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::ucb::XAnyCompareFactory const *) {
    const ::css::uno::Type &rRet = *detail::theXAnyCompareFactoryType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sReturnType0( "com.sun.star.ucb.XAnyCompare" );
                ::rtl::OUString sMethodName0( "com.sun.star.ucb.XAnyCompareFactory::createAnyCompareByName" );
