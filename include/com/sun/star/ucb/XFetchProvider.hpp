...
struct theXFetchProviderType : public rtl::StaticWithInit< ::css::uno::Type *, theXFetchProviderType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.ucb.XFetchProvider" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.ucb.XFetchProvider::fetch" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::ucb::XFetchProvider const *) {
    const ::css::uno::Type &rRet = *detail::theXFetchProviderType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamName0( "nRowStartPosition" );
                ...
                ::rtl::OUString sParamName1( "nRowCount" );
                ...
                ::rtl::OUString sParamName2( "bDirection" );
                ...
                ::rtl::OUString sReturnType0( "com.sun.star.ucb.FetchResult" );
                ::rtl::OUString sMethodName0( "com.sun.star.ucb.XFetchProvider::fetch" );
