...
struct theXCachedContentResultSetStubFactoryType : public rtl::StaticWithInit< ::css::uno::Type *, theXCachedContentResultSetStubFactoryType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.ucb.XCachedContentResultSetStubFactory" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.ucb.XCachedContentResultSetStubFactory::createCachedContentResultSetStub" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::ucb::XCachedContentResultSetStubFactory const *) {
    const ::css::uno::Type &rRet = *detail::theXCachedContentResultSetStubFactoryType::get();
