...
struct theXContentEventListenerType : public rtl::StaticWithInit< ::css::uno::Type *, theXContentEventListenerType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.ucb.XContentEventListener" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.ucb.XContentEventListener::contentEvent" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::ucb::XContentEventListener const *) {
    const ::css::uno::Type &rRet = *detail::theXContentEventListenerType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamType0( "com.sun.star.ucb.ContentEvent" );
