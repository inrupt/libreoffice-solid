...
struct theXInteractionAuthFallbackType : public rtl::StaticWithInit< ::css::uno::Type *, theXInteractionAuthFallbackType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.ucb.XInteractionAuthFallback" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.ucb.XInteractionAuthFallback::setCode" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::ucb::XInteractionAuthFallback const *) {
    const ::css::uno::Type &rRet = *detail::theXInteractionAuthFallbackType::get();
