...
struct theIllegalIdentifierExceptionType : public rtl::StaticWithInit< ::css::uno::Type *, theIllegalIdentifierExceptionType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.ucb.IllegalIdentifierException" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::ucb::IllegalIdentifierException const *) {
    return *detail::theIllegalIdentifierExceptionType::get();
}
