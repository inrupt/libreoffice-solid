...
struct theXDynamicResultSetListenerType : public rtl::StaticWithInit< ::css::uno::Type *, theXDynamicResultSetListenerType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.ucb.XDynamicResultSetListener" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.ucb.XDynamicResultSetListener::notify" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::ucb::XDynamicResultSetListener const *) {
    const ::css::uno::Type &rRet = *detail::theXDynamicResultSetListenerType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamName0( "Changes" );
                ::rtl::OUString sParamType0( "com.sun.star.ucb.ListEvent" );
...
template<> struct IsUnoInterfaceType<::css::ucb::XDynamicResultSetListener>: ::std::true_type {};
}
#endif
