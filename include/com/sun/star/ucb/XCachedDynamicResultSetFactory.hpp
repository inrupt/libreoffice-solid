...
struct theXCachedDynamicResultSetFactoryType : public rtl::StaticWithInit< ::css::uno::Type *, theXCachedDynamicResultSetFactoryType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.ucb.XCachedDynamicResultSetFactory" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.ucb.XCachedDynamicResultSetFactory::createCachedDynamicResultSet" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::ucb::XCachedDynamicResultSetFactory const *) {
    const ::css::uno::Type &rRet = *detail::theXCachedDynamicResultSetFactoryType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamName0( "SourceStub" );
                ...
                ::rtl::OUString sParamName1( "ContentIdentifierMapping" );
...
template<> struct IsUnoInterfaceType<::css::ucb::XCachedDynamicResultSetFactory>: ::std::true_type {};
}
#endif
