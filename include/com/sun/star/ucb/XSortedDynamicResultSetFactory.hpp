...
struct theXSortedDynamicResultSetFactoryType : public rtl::StaticWithInit< ::css::uno::Type *, theXSortedDynamicResultSetFactoryType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.ucb.XSortedDynamicResultSetFactory" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.ucb.XSortedDynamicResultSetFactory::createSortedDynamicResultSet" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::ucb::XSortedDynamicResultSetFactory const *) {
    const ::css::uno::Type &rRet = *detail::theXSortedDynamicResultSetFactoryType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamType1( "[]com.sun.star.ucb.NumberedSortingInfo" );
                ...
                ::rtl::OUString sParamName2( "CompareFactory" );
                ::rtl::OUString sParamType2( "com.sun.star.ucb.XAnyCompareFactory" );
