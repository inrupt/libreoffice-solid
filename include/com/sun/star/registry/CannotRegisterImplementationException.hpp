...
struct theCannotRegisterImplementationExceptionType : public rtl::StaticWithInit< ::css::uno::Type *, theCannotRegisterImplementationExceptionType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.registry.CannotRegisterImplementationException" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::registry::CannotRegisterImplementationException const *) {
    return *detail::theCannotRegisterImplementationExceptionType::get();
}
