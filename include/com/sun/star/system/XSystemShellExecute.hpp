...
struct theXSystemShellExecuteType : public rtl::StaticWithInit< ::css::uno::Type *, theXSystemShellExecuteType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.system.XSystemShellExecute" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.system.XSystemShellExecute::execute" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::system::XSystemShellExecute const *) {
    const ::css::uno::Type &rRet = *detail::theXSystemShellExecuteType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamName1( "aParameter" );
                ...
                ::rtl::OUString sParamName2( "nFlags" );
                ...
                ::rtl::OUString the_ExceptionName1( "com.sun.star.system.SystemShellExecuteException" );
...
template<> struct IsUnoInterfaceType<::css::system::XSystemShellExecute>: ::std::true_type {};
}
#endif
