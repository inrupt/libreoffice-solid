...
struct theXSimpleMailClientType : public rtl::StaticWithInit< ::css::uno::Type *, theXSimpleMailClientType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.system.XSimpleMailClient" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.system.XSimpleMailClient::createSimpleMailMessage" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.system.XSimpleMailClient::sendSimpleMailMessage" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::system::XSimpleMailClient const *) {
    const ::css::uno::Type &rRet = *detail::theXSimpleMailClientType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sReturnType0( "com.sun.star.system.XSimpleMailMessage" );
                ::rtl::OUString sMethodName0( "com.sun.star.system.XSimpleMailClient::createSimpleMailMessage" );
            ...
            }
            {
                ...
                ::rtl::OUString sParamName0( "xSimpleMailMessage" );
                ::rtl::OUString sParamType0( "com.sun.star.system.XSimpleMailMessage" );
                aParameters[0].pParamName = sParamName0.pData;
                aParameters[0].eTypeClass = (typelib_TypeClass)::css::uno::TypeClass_INTERFACE;
                aParameters[0].pTypeName = sParamType0.pData;
                aParameters[0].bIn = sal_True;
                aParameters[0].bOut = sal_False;
                ::rtl::OUString sParamName1( "aFlag" );
...
template<> struct IsUnoInterfaceType<::css::system::XSimpleMailClient>: ::std::true_type {};
}
#endif
