...
struct theXExactNameType : public rtl::StaticWithInit< ::css::uno::Type *, theXExactNameType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.beans.XExactName" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.beans.XExactName::getExactName" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::beans::XExactName const *) {
    const ::css::uno::Type &rRet = *detail::theXExactNameType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamName0( "aApproximateName" );
