...
struct theXPropertySetInfoChangeListenerType : public rtl::StaticWithInit< ::css::uno::Type *, theXPropertySetInfoChangeListenerType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.beans.XPropertySetInfoChangeListener" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.beans.XPropertySetInfoChangeListener::propertySetInfoChange" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::beans::XPropertySetInfoChangeListener const *) {
    const ::css::uno::Type &rRet = *detail::theXPropertySetInfoChangeListenerType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamType0( "com.sun.star.beans.PropertySetInfoChangeEvent" );
