...
struct theXPropertyStateChangeListenerType : public rtl::StaticWithInit< ::css::uno::Type *, theXPropertyStateChangeListenerType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.beans.XPropertyStateChangeListener" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.beans.XPropertyStateChangeListener::propertyStateChange" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::beans::XPropertyStateChangeListener const *) {
    const ::css::uno::Type &rRet = *detail::theXPropertyStateChangeListenerType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamType0( "com.sun.star.beans.PropertyStateChangeEvent" );
