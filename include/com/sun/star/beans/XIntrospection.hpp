...
struct theXIntrospectionType : public rtl::StaticWithInit< ::css::uno::Type *, theXIntrospectionType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.beans.XIntrospection" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.beans.XIntrospection::inspect" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::beans::XIntrospection const *) {
    const ::css::uno::Type &rRet = *detail::theXIntrospectionType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamName0( "aObject" );
                ...
                ::rtl::OUString sReturnType0( "com.sun.star.beans.XIntrospectionAccess" );
                ::rtl::OUString sMethodName0( "com.sun.star.beans.XIntrospection::inspect" );
