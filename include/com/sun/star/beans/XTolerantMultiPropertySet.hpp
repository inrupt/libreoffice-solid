...
struct theXTolerantMultiPropertySetType : public rtl::StaticWithInit< ::css::uno::Type *, theXTolerantMultiPropertySetType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.beans.XTolerantMultiPropertySet" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.beans.XTolerantMultiPropertySet::setPropertyValuesTolerant" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.beans.XTolerantMultiPropertySet::getPropertyValuesTolerant" );
        typelib_typedescriptionreference_new( &pMembers[1],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName1.pData );
        ::rtl::OUString sMethodName2( "com.sun.star.beans.XTolerantMultiPropertySet::getDirectPropertyValuesTolerant" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::beans::XTolerantMultiPropertySet const *) {
    const ::css::uno::Type &rRet = *detail::theXTolerantMultiPropertySetType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sReturnType0( "[]com.sun.star.beans.SetPropertyTolerantFailed" );
                ::rtl::OUString sMethodName0( "com.sun.star.beans.XTolerantMultiPropertySet::setPropertyValuesTolerant" );
            ...
            }
            {
                ...
                ::rtl::OUString sReturnType1( "[]com.sun.star.beans.GetPropertyTolerantResult" );
                ::rtl::OUString sMethodName1( "com.sun.star.beans.XTolerantMultiPropertySet::getPropertyValuesTolerant" );
                typelib_typedescription_newInterfaceMethod( &pMethod,
                    4, sal_False,
                    sMethodName1.pData,
            ...
            }
            {
                ...
                ::rtl::OUString the_ExceptionName0( "com.sun.star.uno.RuntimeException" );
                rtl_uString * the_Exceptions[] = { the_ExceptionName0.pData };
                ::rtl::OUString sReturnType2( "[]com.sun.star.beans.GetDirectPropertyTolerantResult" );
                ::rtl::OUString sMethodName2( "com.sun.star.beans.XTolerantMultiPropertySet::getDirectPropertyValuesTolerant" );
                typelib_typedescription_newInterfaceMethod( &pMethod,
                    5, sal_False,
                    sMethodName2.pData,
