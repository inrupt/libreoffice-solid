...
struct theXPropertySetInfoChangeNotifierType : public rtl::StaticWithInit< ::css::uno::Type *, theXPropertySetInfoChangeNotifierType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.beans.XPropertySetInfoChangeNotifier" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.beans.XPropertySetInfoChangeNotifier::addPropertySetInfoChangeListener" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.beans.XPropertySetInfoChangeNotifier::removePropertySetInfoChangeListener" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::beans::XPropertySetInfoChangeNotifier const *) {
    const ::css::uno::Type &rRet = *detail::theXPropertySetInfoChangeNotifierType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamType0( "com.sun.star.beans.XPropertySetInfoChangeListener" );
