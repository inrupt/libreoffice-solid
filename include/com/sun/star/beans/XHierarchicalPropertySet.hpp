...
struct theXHierarchicalPropertySetType : public rtl::StaticWithInit< ::css::uno::Type *, theXHierarchicalPropertySetType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.beans.XHierarchicalPropertySet" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.beans.XHierarchicalPropertySet::getHierarchicalPropertySetInfo" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.beans.XHierarchicalPropertySet::setHierarchicalPropertyValue" );
        typelib_typedescriptionreference_new( &pMembers[1],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName1.pData );
        ::rtl::OUString sMethodName2( "com.sun.star.beans.XHierarchicalPropertySet::getHierarchicalPropertyValue" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::beans::XHierarchicalPropertySet const *) {
    const ::css::uno::Type &rRet = *detail::theXHierarchicalPropertySetType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sReturnType0( "com.sun.star.beans.XHierarchicalPropertySetInfo" );
                ::rtl::OUString sMethodName0( "com.sun.star.beans.XHierarchicalPropertySet::getHierarchicalPropertySetInfo" );
            ...
            }
            {
                ...
                ::rtl::OUString sParamName0( "aHierarchicalPropertyName" );
...
template<> struct IsUnoInterfaceType<::css::beans::XHierarchicalPropertySet>: ::std::true_type {};
}
#endif
