...
struct theNamedValueType : public rtl::StaticWithInit< ::css::uno::Type *, theNamedValueType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString the_name( "com.sun.star.beans.NamedValue" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::beans::NamedValue const *) {
    return *detail::theNamedValueType::get();
}
