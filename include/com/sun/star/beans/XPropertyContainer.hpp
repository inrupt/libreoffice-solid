...
struct theXPropertyContainerType : public rtl::StaticWithInit< ::css::uno::Type *, theXPropertyContainerType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.beans.XPropertyContainer" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.beans.XPropertyContainer::addProperty" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.beans.XPropertyContainer::removeProperty" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::beans::XPropertyContainer const *) {
    const ::css::uno::Type &rRet = *detail::theXPropertyContainerType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamName1( "Attributes" );
                ...
                ::rtl::OUString sParamName2( "DefaultValue" );
                ...
                ::rtl::OUString the_ExceptionName0( "com.sun.star.beans.PropertyExistException" );
            ...
            }
            {
                ...
                ::rtl::OUString the_ExceptionName1( "com.sun.star.beans.NotRemoveableException" );
...
template<> struct IsUnoInterfaceType<::css::beans::XPropertyContainer>: ::std::true_type {};
}
#endif
