...
struct theXMultiHierarchicalPropertySetType : public rtl::StaticWithInit< ::css::uno::Type *, theXMultiHierarchicalPropertySetType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.beans.XMultiHierarchicalPropertySet" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.beans.XMultiHierarchicalPropertySet::getHierarchicalPropertySetInfo" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.beans.XMultiHierarchicalPropertySet::setHierarchicalPropertyValues" );
        typelib_typedescriptionreference_new( &pMembers[1],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName1.pData );
        ::rtl::OUString sMethodName2( "com.sun.star.beans.XMultiHierarchicalPropertySet::getHierarchicalPropertyValues" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::beans::XMultiHierarchicalPropertySet const *) {
    const ::css::uno::Type &rRet = *detail::theXMultiHierarchicalPropertySetType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            }
            {
                ...
                ::rtl::OUString sParamName0( "aHierarchicalPropertyNames" );
                ...
                ::rtl::OUString sParamName1( "Values" );
