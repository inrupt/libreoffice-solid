...
{
    ::cppu::UnoType< ::css::lang::NoSuchFieldException >::get();
}
...
struct theNoSuchFieldExceptionType : public rtl::StaticWithInit< ::css::uno::Type *, theNoSuchFieldExceptionType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.lang.NoSuchFieldException" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::lang::NoSuchFieldException const *) {
    return *detail::theNoSuchFieldExceptionType::get();
}
