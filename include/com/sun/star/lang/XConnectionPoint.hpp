...
struct theXConnectionPointType : public rtl::StaticWithInit< ::css::uno::Type *, theXConnectionPointType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.lang.XConnectionPoint" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.lang.XConnectionPoint::getConnectionType" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.lang.XConnectionPoint::getConnectionPointContainer" );
        typelib_typedescriptionreference_new( &pMembers[1],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName1.pData );
        ::rtl::OUString sMethodName2( "com.sun.star.lang.XConnectionPoint::advise" );
        typelib_typedescriptionreference_new( &pMembers[2],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName2.pData );
        ::rtl::OUString sMethodName3( "com.sun.star.lang.XConnectionPoint::unadvise" );
        typelib_typedescriptionreference_new( &pMembers[3],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName3.pData );
        ::rtl::OUString sMethodName4( "com.sun.star.lang.XConnectionPoint::getConnections" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::lang::XConnectionPoint const *) {
    const ::css::uno::Type &rRet = *detail::theXConnectionPointType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            }
            {
                ::rtl::OUString the_ExceptionName0( "com.sun.star.uno.RuntimeException" );
                rtl_uString * the_Exceptions[] = { the_ExceptionName0.pData };
                ::rtl::OUString sReturnType1( "com.sun.star.lang.XConnectionPointContainer" );
                ::rtl::OUString sMethodName1( "com.sun.star.lang.XConnectionPoint::getConnectionPointContainer" );
                typelib_typedescription_newInterfaceMethod( &pMethod,
                    4, sal_False,
                    sMethodName1.pData,
            ...
            }
            {
                ...
                ::rtl::OUString the_ExceptionName0( "com.sun.star.lang.ListenerExistException" );
                ::rtl::OUString the_ExceptionName1( "com.sun.star.lang.InvalidListenerException" );
            ...
            }
            {
                ::rtl::OUString the_ExceptionName0( "com.sun.star.uno.RuntimeException" );
                rtl_uString * the_Exceptions[] = { the_ExceptionName0.pData };
                ::rtl::OUString sReturnType4( "[]com.sun.star.uno.XInterface" );
                ::rtl::OUString sMethodName4( "com.sun.star.lang.XConnectionPoint::getConnections" );
                typelib_typedescription_newInterfaceMethod( &pMethod,
                    7, sal_False,
                    sMethodName4.pData,
