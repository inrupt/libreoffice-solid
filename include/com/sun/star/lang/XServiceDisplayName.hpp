...
struct theXServiceDisplayNameType : public rtl::StaticWithInit< ::css::uno::Type *, theXServiceDisplayNameType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.lang.XServiceDisplayName" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.lang.XServiceDisplayName::getServiceDisplayName" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::lang::XServiceDisplayName const *) {
    const ::css::uno::Type &rRet = *detail::theXServiceDisplayNameType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamName0( "aLocale" );
