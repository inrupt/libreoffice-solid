...
{
    ::cppu::UnoType< ::css::lang::NoSuchMethodException >::get();
}
...
struct theNoSuchMethodExceptionType : public rtl::StaticWithInit< ::css::uno::Type *, theNoSuchMethodExceptionType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.lang.NoSuchMethodException" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::lang::NoSuchMethodException const *) {
    return *detail::theNoSuchMethodExceptionType::get();
}
