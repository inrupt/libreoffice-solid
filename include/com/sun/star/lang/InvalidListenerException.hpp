...
{
    ::cppu::UnoType< ::css::lang::InvalidListenerException >::get();
}
...
struct theInvalidListenerExceptionType : public rtl::StaticWithInit< ::css::uno::Type *, theInvalidListenerExceptionType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.lang.InvalidListenerException" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::lang::InvalidListenerException const *) {
    return *detail::theInvalidListenerExceptionType::get();
}
