...
struct theXMainType : public rtl::StaticWithInit< ::css::uno::Type *, theXMainType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.lang.XMain" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.lang.XMain::run" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::lang::XMain const *) {
    const ::css::uno::Type &rRet = *detail::theXMainType::get();
