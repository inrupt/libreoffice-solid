...
struct theXChangesNotifierType : public rtl::StaticWithInit< ::css::uno::Type *, theXChangesNotifierType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.util.XChangesNotifier" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.util.XChangesNotifier::addChangesListener" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.util.XChangesNotifier::removeChangesListener" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::util::XChangesNotifier const *) {
    const ::css::uno::Type &rRet = *detail::theXChangesNotifierType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamType0( "com.sun.star.util.XChangesListener" );
