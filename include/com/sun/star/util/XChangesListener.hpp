...
struct theXChangesListenerType : public rtl::StaticWithInit< ::css::uno::Type *, theXChangesListenerType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.util.XChangesListener" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.util.XChangesListener::changesOccurred" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::util::XChangesListener const *) {
    const ::css::uno::Type &rRet = *detail::theXChangesListenerType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamType0( "com.sun.star.util.ChangesEvent" );
...
template<> struct IsUnoInterfaceType<::css::util::XChangesListener>: ::std::true_type {};
}
#endif
