...
struct theSearchOptions2Type : public rtl::StaticWithInit< ::css::uno::Type *, theSearchOptions2Type >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString the_name( "com.sun.star.util.SearchOptions2" );
        ::rtl::OUString the_tname0( "short" );
        ::rtl::OUString the_name0( "AlgorithmType2" );
        ::rtl::OUString the_tname1( "long" );
        ::rtl::OUString the_name1( "WildcardEscapeCharacter" );
        ...
        ::typelib_typedescription_newStruct(&the_newType, the_name.pData, ::cppu::UnoType< ::css::util::SearchOptions >::get().getTypeLibType(), 2, the_members);
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::util::SearchOptions2 const *) {
    return *detail::theSearchOptions2Type::get();
}
