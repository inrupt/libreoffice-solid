...
struct theXStringAbbreviationType : public rtl::StaticWithInit< ::css::uno::Type *, theXStringAbbreviationType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.util.XStringAbbreviation" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.util.XStringAbbreviation::abbreviateString" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::util::XStringAbbreviation const *) {
    const ::css::uno::Type &rRet = *detail::theXStringAbbreviationType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamName0( "xStringWidth" );
                ::rtl::OUString sParamType0( "com.sun.star.util.XStringWidth" );
                aParameters[0].pParamName = sParamName0.pData;
                aParameters[0].eTypeClass = (typelib_TypeClass)::css::uno::TypeClass_INTERFACE;
                aParameters[0].pTypeName = sParamType0.pData;
                aParameters[0].bIn = sal_True;
                aParameters[0].bOut = sal_False;
                ::rtl::OUString sParamName1( "nWidth" );
                ...
                ::rtl::OUString sParamName2( "aString" );
...
template<> struct IsUnoInterfaceType<::css::util::XStringAbbreviation>: ::std::true_type {};
}
#endif
