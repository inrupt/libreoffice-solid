...
struct theXSortableType : public rtl::StaticWithInit< ::css::uno::Type *, theXSortableType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.util.XSortable" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.util.XSortable::createSortDescriptor" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.util.XSortable::sort" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::util::XSortable const *) {
    const ::css::uno::Type &rRet = *detail::theXSortableType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            }
            {
                ...
                ::rtl::OUString sParamName0( "xDescriptor" );
...
template<> struct IsUnoInterfaceType<::css::util::XSortable>: ::std::true_type {};
}
#endif
