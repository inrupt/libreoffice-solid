...
struct theXStringWidthType : public rtl::StaticWithInit< ::css::uno::Type *, theXStringWidthType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.util.XStringWidth" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.util.XStringWidth::queryStringWidth" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::util::XStringWidth const *) {
    const ::css::uno::Type &rRet = *detail::theXStringWidthType::get();
...
template<> struct IsUnoInterfaceType<::css::util::XStringWidth>: ::std::true_type {};
}
#endif
