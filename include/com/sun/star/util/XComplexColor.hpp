...
struct theXComplexColorType : public rtl::StaticWithInit< ::css::uno::Type *, theXComplexColorType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.util.XComplexColor" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.util.XComplexColor::getType" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.util.XComplexColor::getThemeColorType" );
        typelib_typedescriptionreference_new( &pMembers[1],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName1.pData );
        ::rtl::OUString sMethodName2( "com.sun.star.util.XComplexColor::resolveColor" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::util::XComplexColor const *) {
    const ::css::uno::Type &rRet = *detail::theXComplexColorType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            }
            {
                ...
                ::rtl::OUString sParamName0( "xTheme" );
                ::rtl::OUString sParamType0( "com.sun.star.util.XTheme" );
