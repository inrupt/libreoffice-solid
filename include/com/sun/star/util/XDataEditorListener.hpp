...
struct theXDataEditorListenerType : public rtl::StaticWithInit< ::css::uno::Type *, theXDataEditorListenerType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.util.XDataEditorListener" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.util.XDataEditorListener::updateDataEditorState" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::util::XDataEditorListener const *) {
    const ::css::uno::Type &rRet = *detail::theXDataEditorListenerType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamType0( "com.sun.star.util.DataEditorEvent" );
