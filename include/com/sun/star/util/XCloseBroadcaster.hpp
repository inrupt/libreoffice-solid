...
struct theXCloseBroadcasterType : public rtl::StaticWithInit< ::css::uno::Type *, theXCloseBroadcasterType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.util.XCloseBroadcaster" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.util.XCloseBroadcaster::addCloseListener" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.util.XCloseBroadcaster::removeCloseListener" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::util::XCloseBroadcaster const *) {
    const ::css::uno::Type &rRet = *detail::theXCloseBroadcasterType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamType0( "com.sun.star.util.XCloseListener" );
