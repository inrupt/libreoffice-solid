...
struct theXModifyListenerType : public rtl::StaticWithInit< ::css::uno::Type *, theXModifyListenerType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.util.XModifyListener" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.util.XModifyListener::modified" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::util::XModifyListener const *) {
    const ::css::uno::Type &rRet = *detail::theXModifyListenerType::get();
