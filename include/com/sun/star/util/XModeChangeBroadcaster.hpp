...
struct theXModeChangeBroadcasterType : public rtl::StaticWithInit< ::css::uno::Type *, theXModeChangeBroadcasterType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.util.XModeChangeBroadcaster" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.util.XModeChangeBroadcaster::addModeChangeListener" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.util.XModeChangeBroadcaster::removeModeChangeListener" );
        typelib_typedescriptionreference_new( &pMembers[1],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName1.pData );
        ::rtl::OUString sMethodName2( "com.sun.star.util.XModeChangeBroadcaster::addModeChangeApproveListener" );
        typelib_typedescriptionreference_new( &pMembers[2],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName2.pData );
        ::rtl::OUString sMethodName3( "com.sun.star.util.XModeChangeBroadcaster::removeModeChangeApproveListener" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::util::XModeChangeBroadcaster const *) {
    const ::css::uno::Type &rRet = *detail::theXModeChangeBroadcasterType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamName0( "rxListener" );
                ::rtl::OUString sParamType0( "com.sun.star.util.XModeChangeListener" );
            ...
            }
            {
                typelib_Parameter_Init aParameters[1];
                ::rtl::OUString sParamName0( "rxListener" );
                ::rtl::OUString sParamType0( "com.sun.star.util.XModeChangeApproveListener" );
                aParameters[0].pParamName = sParamName0.pData;
                aParameters[0].eTypeClass = (typelib_TypeClass)::css::uno::TypeClass_INTERFACE;
                aParameters[0].pTypeName = sParamType0.pData;
                aParameters[0].bIn = sal_True;
