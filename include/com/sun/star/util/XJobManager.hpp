...
struct theXJobManagerType : public rtl::StaticWithInit< ::css::uno::Type *, theXJobManagerType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.util.XJobManager" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.util.XJobManager::registerJob" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.util.XJobManager::releaseJob" );
        typelib_typedescriptionreference_new( &pMembers[1],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName1.pData );
        ::rtl::OUString sMethodName2( "com.sun.star.util.XJobManager::cancelAllJobs" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::util::XJobManager const *) {
    const ::css::uno::Type &rRet = *detail::theXJobManagerType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamName0( "Job" );
                ::rtl::OUString sParamType0( "com.sun.star.util.XCancellable" );
