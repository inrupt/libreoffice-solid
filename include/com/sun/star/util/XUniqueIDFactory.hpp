...
struct theXUniqueIDFactoryType : public rtl::StaticWithInit< ::css::uno::Type *, theXUniqueIDFactoryType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.util.XUniqueIDFactory" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.util.XUniqueIDFactory::createUniqueID" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::util::XUniqueIDFactory const *) {
    const ::css::uno::Type &rRet = *detail::theXUniqueIDFactoryType::get();
...
template<> struct IsUnoInterfaceType<::css::util::XUniqueIDFactory>: ::std::true_type {};
}
#endif
