...
struct theXChainableType : public rtl::StaticWithInit< ::css::uno::Type *, theXChainableType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.util.XChainable" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.util.XChainable::getPredecessor" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.util.XChainable::getSuccessor" );
        typelib_typedescriptionreference_new( &pMembers[1],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName1.pData );
        ::rtl::OUString sMethodName2( "com.sun.star.util.XChainable::setSuccessor" );
        typelib_typedescriptionreference_new( &pMembers[2],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName2.pData );
        ::rtl::OUString sMethodName3( "com.sun.star.util.XChainable::isChainable" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::util::XChainable const *) {
    const ::css::uno::Type &rRet = *detail::theXChainableType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sReturnType0( "com.sun.star.util.XChainable" );
                ::rtl::OUString sMethodName0( "com.sun.star.util.XChainable::getPredecessor" );
            ...
            }
            {
                ::rtl::OUString the_ExceptionName0( "com.sun.star.uno.RuntimeException" );
                rtl_uString * the_Exceptions[] = { the_ExceptionName0.pData };
                ::rtl::OUString sReturnType1( "com.sun.star.util.XChainable" );
                ::rtl::OUString sMethodName1( "com.sun.star.util.XChainable::getSuccessor" );
                typelib_typedescription_newInterfaceMethod( &pMethod,
                    4, sal_False,
                    sMethodName1.pData,
            ...
            }
            {
                ...
                ::rtl::OUString sParamName0( "xChainable" );
                ::rtl::OUString sParamType0( "com.sun.star.util.XChainable" );
...
template<> struct IsUnoInterfaceType<::css::util::XChainable>: ::std::true_type {};
}
#endif
