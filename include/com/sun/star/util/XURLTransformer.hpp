...
struct theXURLTransformerType : public rtl::StaticWithInit< ::css::uno::Type *, theXURLTransformerType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.util.XURLTransformer" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.util.XURLTransformer::parseStrict" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.util.XURLTransformer::parseSmart" );
        typelib_typedescriptionreference_new( &pMembers[1],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName1.pData );
        ::rtl::OUString sMethodName2( "com.sun.star.util.XURLTransformer::assemble" );
        typelib_typedescriptionreference_new( &pMembers[2],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName2.pData );
        ::rtl::OUString sMethodName3( "com.sun.star.util.XURLTransformer::getPresentation" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::util::XURLTransformer const *) {
    const ::css::uno::Type &rRet = *detail::theXURLTransformerType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamType0( "com.sun.star.util.URL" );
            ...
            }
            {
                ...
                aParameters[0].bIn = sal_True;
                aParameters[0].bOut = sal_True;
                ::rtl::OUString sParamName1( "sSmartProtocol" );
            ...
            }
            {
                ...
                ::rtl::OUString sParamName1( "bWithPassword" );
...
template<> struct IsUnoInterfaceType<::css::util::XURLTransformer>: ::std::true_type {};
}
#endif
