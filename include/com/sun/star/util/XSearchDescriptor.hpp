...
struct theXSearchDescriptorType : public rtl::StaticWithInit< ::css::uno::Type *, theXSearchDescriptorType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.util.XSearchDescriptor" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.util.XSearchDescriptor::getSearchString" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.util.XSearchDescriptor::setSearchString" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::util::XSearchDescriptor const *) {
    const ::css::uno::Type &rRet = *detail::theXSearchDescriptorType::get();
