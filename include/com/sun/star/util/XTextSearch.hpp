...
struct theXTextSearchType : public rtl::StaticWithInit< ::css::uno::Type *, theXTextSearchType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.util.XTextSearch" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.util.XTextSearch::setOptions" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.util.XTextSearch::searchForward" );
        typelib_typedescriptionreference_new( &pMembers[1],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName1.pData );
        ::rtl::OUString sMethodName2( "com.sun.star.util.XTextSearch::searchBackward" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::util::XTextSearch const *) {
    const ::css::uno::Type &rRet = *detail::theXTextSearchType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamName0( "options" );
                ::rtl::OUString sParamType0( "com.sun.star.util.SearchOptions" );
            ...
            }
            {
                ...
                ::rtl::OUString sParamName0( "searchStr" );
                ...
                aParameters[0].bIn = sal_True;
                aParameters[0].bOut = sal_False;
                ::rtl::OUString sParamName1( "startPos" );
                ...
                ::rtl::OUString sParamName2( "endPos" );
                ...
                ::rtl::OUString the_ExceptionName0( "com.sun.star.uno.RuntimeException" );
                rtl_uString * the_Exceptions[] = { the_ExceptionName0.pData };
                ::rtl::OUString sReturnType1( "com.sun.star.util.SearchResult" );
                ::rtl::OUString sMethodName1( "com.sun.star.util.XTextSearch::searchForward" );
                typelib_typedescription_newInterfaceMethod( &pMethod,
                    4, sal_False,
                    sMethodName1.pData,
            ...
            }
            {
                ...
                ::rtl::OUString the_ExceptionName0( "com.sun.star.uno.RuntimeException" );
                rtl_uString * the_Exceptions[] = { the_ExceptionName0.pData };
                ::rtl::OUString sReturnType2( "com.sun.star.util.SearchResult" );
                ::rtl::OUString sMethodName2( "com.sun.star.util.XTextSearch::searchBackward" );
                typelib_typedescription_newInterfaceMethod( &pMethod,
                    5, sal_False,
                    sMethodName2.pData,
