...
struct theTriStateType : public rtl::StaticWithInit< ::css::uno::Type *, theTriStateType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.util.TriState" );
        ...
        ::rtl::OUString sEnumValue1( "YES" );
        enumValueNames[1] = sEnumValue1.pData;
        ::rtl::OUString sEnumValue2( "INDETERMINATE" );
        ...
        typelib_typedescription_newEnum( &pTD,
            sTypeName.pData,
            (sal_Int32)::com::sun::star::util::TriState_NO,
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::util::TriState const *) {
    return *detail::theTriStateType::get();
}

} } } }

SAL_DEPRECATED("use cppu::UnoType") inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::util::TriState const *) {
    return ::cppu::UnoType< ::css::util::TriState >::get();
}
