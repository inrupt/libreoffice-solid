...
struct theXModeChangeApproveListenerType : public rtl::StaticWithInit< ::css::uno::Type *, theXModeChangeApproveListenerType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.util.XModeChangeApproveListener" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.util.XModeChangeApproveListener::approveModeChange" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::util::XModeChangeApproveListener const *) {
    const ::css::uno::Type &rRet = *detail::theXModeChangeApproveListenerType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamName0( "rSource" );
                ::rtl::OUString sParamType0( "com.sun.star.util.ModeChangeEvent" );
                aParameters[0].pParamName = sParamName0.pData;
                aParameters[0].eTypeClass = (typelib_TypeClass)::css::uno::TypeClass_STRUCT;
                aParameters[0].pTypeName = sParamType0.pData;
                aParameters[0].bIn = sal_True;
                aParameters[0].bOut = sal_False;
                ::rtl::OUString the_ExceptionName0( "com.sun.star.util.VetoException" );
