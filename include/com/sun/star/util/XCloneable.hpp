...
struct theXCloneableType : public rtl::StaticWithInit< ::css::uno::Type *, theXCloneableType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.util.XCloneable" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.util.XCloneable::createClone" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::util::XCloneable const *) {
    const ::css::uno::Type &rRet = *detail::theXCloneableType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sReturnType0( "com.sun.star.util.XCloneable" );
                ::rtl::OUString sMethodName0( "com.sun.star.util.XCloneable::createClone" );
