...
struct theXTimeStampedType : public rtl::StaticWithInit< ::css::uno::Type *, theXTimeStampedType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.util.XTimeStamped" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.util.XTimeStamped::getTimestamp" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::util::XTimeStamped const *) {
    const ::css::uno::Type &rRet = *detail::theXTimeStampedType::get();
