...
struct theXRefreshListenerType : public rtl::StaticWithInit< ::css::uno::Type *, theXRefreshListenerType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.util.XRefreshListener" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.util.XRefreshListener::refreshed" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::util::XRefreshListener const *) {
    const ::css::uno::Type &rRet = *detail::theXRefreshListenerType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamName0( "rEvent" );
...
template<> struct IsUnoInterfaceType<::css::util::XRefreshListener>: ::std::true_type {};
}
#endif
