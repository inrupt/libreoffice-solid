...
struct theXModifyBroadcasterType : public rtl::StaticWithInit< ::css::uno::Type *, theXModifyBroadcasterType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.util.XModifyBroadcaster" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.util.XModifyBroadcaster::addModifyListener" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.util.XModifyBroadcaster::removeModifyListener" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::util::XModifyBroadcaster const *) {
    const ::css::uno::Type &rRet = *detail::theXModifyBroadcasterType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamType0( "com.sun.star.util.XModifyListener" );
