...
struct theXCloseListenerType : public rtl::StaticWithInit< ::css::uno::Type *, theXCloseListenerType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.util.XCloseListener" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.util.XCloseListener::queryClosing" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.util.XCloseListener::notifyClosing" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::util::XCloseListener const *) {
    const ::css::uno::Type &rRet = *detail::theXCloseListenerType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamName1( "GetsOwnership" );
