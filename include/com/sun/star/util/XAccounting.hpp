...
struct theXAccountingType : public rtl::StaticWithInit< ::css::uno::Type *, theXAccountingType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.util.XAccounting" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.util.XAccounting::estimateUsage" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::util::XAccounting const *) {
    const ::css::uno::Type &rRet = *detail::theXAccountingType::get();
