...
struct theXChangesSetType : public rtl::StaticWithInit< ::css::uno::Type *, theXChangesSetType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.util.XChangesSet" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.util.XChangesSet::getAllChanges" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::util::XChangesSet const *) {
    const ::css::uno::Type &rRet = *detail::theXChangesSetType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sReturnType0( "[]com.sun.star.util.ElementChange" );
                ::rtl::OUString sMethodName0( "com.sun.star.util.XChangesSet::getAllChanges" );
