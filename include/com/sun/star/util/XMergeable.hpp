...
struct theXMergeableType : public rtl::StaticWithInit< ::css::uno::Type *, theXMergeableType >
{
    ::css::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.util.XMergeable" );
        ...
        ::rtl::OUString sMethodName0( "com.sun.star.util.XMergeable::merge" );
        typelib_typedescriptionreference_new( &pMembers[0],
                                              (typelib_TypeClass)::css::uno::TypeClass_INTERFACE_METHOD,
                                              sMethodName0.pData );
        ::rtl::OUString sMethodName1( "com.sun.star.util.XMergeable::getIsMerged" );
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::util::XMergeable const *) {
    const ::css::uno::Type &rRet = *detail::theXMergeableType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                ::rtl::OUString sParamName0( "bMerge" );
